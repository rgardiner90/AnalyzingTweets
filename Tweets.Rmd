...
afinn_sentiments %>%
  ...
  scale_x_reordered() +
  facet_wrap(~ Candidate, scales = "free") +
  ggtitle("Figure 8: Most Strongly Empahsized Negative Words by Candidate") +
  theme_light() +
  theme(panel.grid.minor = element_blank(),
        panel.grid.major.y = element_blank(),
        plot.title = element_text(face = "bold", size = 14, hjust = 0.5),
...
afinn_sentiments %>%
  ...
  geom_col(show.legend = FALSE) +
  coord_flip() +
  labs(x = "", y = "Impact", title = "Most Strongly Emphasized Words by Candidate") +
  scale_x_reordered() +
  facet_wrap(~ Candidate, scales = "free") +
  theme_light() +
  theme(panel.grid.minor = element_blank(),
