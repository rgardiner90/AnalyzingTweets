...
2. Once a model has been decided, you need to create a graphic or table that shows the words have the largest (and maybe smallest) betas for each topic. Try to define them in simple terms.
