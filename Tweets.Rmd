...
afinn_sentiments %>%
  ...
  scale_x_reordered() +
  facet_wrap(~ Candidate, scales = "free") +
  ggtitle("Most Impactful Positive Words by Candidate")

ggsave("afinn most impactful positive.png")
```
...
afinn_sentiments %>%
  ...
  scale_x_reordered() +
  facet_wrap(~ Candidate, scales = "free") +
  ggtitle("Most Impactful Negative Words by Candidate")

ggsave("afinn most impactful negative.png")
```
